                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('sports.destroy',$sport->id) }}" method="POST">
                                    <div class="btn-group">
                                        <a class="btn btn-success" href="{{ route('sports.show',$sport->id) }}" data-toggle="tooltip" title="Show">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a class="btn btn-primary" href="{{ route('sports.edit',$sport->id) }}" data-toggle="tooltip" title="Edit">
