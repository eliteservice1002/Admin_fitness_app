                ...
                <div class="content-header bg-white-10">
                    ...
                    <a class="link-fx font-w600 font-size-lg text-white" href="/">
                        ...
                        <span class="smini-hidden">
                            <span class="text-white-75">Food</span><span class="text-white">management</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <ul class="nav-main">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link<?php echo e(request()->is('recipes*') ? ' active' : ''); ?>" href="/recipes">
                            ...
                            <span class="nav-main-link-name">Recipe</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link<?php echo e(request()->is('foodcategories*') ? ' active' : ''); ?>" href="/foodcategories">
                            <i class="nav-main-link-icon si si-notebook"></i>
                            <span class="nav-main-link-name">FoodCategory</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link<?php echo e(request()->is('fooditems*') ? ' active' : ''); ?>" href="/fooditems">
                            ...
                            <span class="nav-main-link-name">Food item</span>
                        </a>
                    </li>
...
</html><?php /**PATH D:\xampp\htdocs\Fitness\resources\views/layouts/backend.blade.php ENDPATH**/ ?>